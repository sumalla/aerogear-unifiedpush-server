...
public class MessageHolderWithTokensKafkaConsumer {
    ...
    public final String ADM_TOPIC = "AdmToken_Topic";

    public final String APNS_TOPIC = "APNsToken_Topic";

    public final String FCM_TOPIC = "FCMToken_Topic";

    public final String MPNS_TOPIC = "MPNSToken_Topic";

    public final String MOZ_TOPIC = "SimplePushToken_Topic";

    public final String WNS_TOPIC = "WNSToken_Topic";
