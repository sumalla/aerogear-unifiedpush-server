...
public class JPAPushMetricsAggregatorDao extends JPABaseDao<PushMetricsAggregator, String> implements PushMetricsAggregatorDao {
    @Override
    public PushMetricsAggregator findAllForPushApplication(String pushApplicationId) {
        return getSingleResultForQuery(createQuery(
                "select pma from PushMetricsAggregator pma where pma.pushApplicationID = :pushApplicationID")
                .setParameter("pushApplicationID", pushApplicationId));
    }

    @Override
    public Class<PushMetricsAggregator> getType() {
        return PushMetricsAggregator.class;
    }
}
